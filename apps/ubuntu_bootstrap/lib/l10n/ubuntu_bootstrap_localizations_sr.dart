...
class UbuntuBootstrapLocalizationsSr extends UbuntuBootstrapLocalizations {
  ...
  @override
  String get confirmPartitionChanges => 'Следеће промене партиција ће бити примењене:';

  @override
  String confirmPartitionResize(String sysname, String oldsize, String newsize) {
    return 'партиција <b>$sysname</b> промењена са <b>$oldsize</b> на <b>$newsize</b>';
  }

  @override
  String confirmPartitionFormatMount(String sysname, String format, String mount) {
    return 'партиција <b>$sysname</b> форматирана као <b>$format</b> коришћена за <b>$mount</b>';
  }

  @override
  String confirmPartitionFormat(String sysname, String format) {
    return 'партиција <b>$sysname</b> форматирана као <b>$format</b>';
  }

  @override
  String confirmPartitionMount(String sysname, String mount) {
    return 'партиција <b>$sysname</b> коришћена за <b>$mount</b>';
  }

  @override
  String confirmPartitionCreate(String sysname) {
    return 'партиција <b>$sysname</b> креирана';
  }
  ...
  @override
  String get bitlockerTitle => 'BitLocker је омогућен';

  @override
  String get bitlockerHeader => 'Искључите BitLocker да бисте наставили';

  @override
  String bitlockerDescription(String option) {
    return 'Овај рачунар користи Windows BitLocker енкрипцију.\nПотребно је да користите Windows да бисте креирали слободан простор или се вратите и изаберете \'$option\' да бисте наставили.';
  }
